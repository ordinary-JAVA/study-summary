...
public class MySQLConditionBuilder {
    ...
    public static String generate(QueryEntity entity, FieldType fieldType, String paramName, int postion) {
    ...
    private static String subConditionByFilter(FieldType fieldType, String value, String format) {
